                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('domains.store') }}" method="POST" class="space-y-5">
                        ...
                        <div>
                            ...
                            <x-text-input id="registrar" class="block mt-1 w-full" type="text" name="registrar" :value="old('registrar')" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="registrar_url" class="block mt-1 w-full" type="url" name="registrar_url" :value="old('registrar_url')" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="expiration" class="block mt-1 w-full" type="date" name="expiration" :value="old('expiration')" required />
                            ...
                            <fieldset class="mt-4">
                                ...
                                <div class="space-y-4 sm:flex sm:items-center sm:space-x-10 sm:space-y-0">
                                    <div class="flex items-center">
                                        <input value="1" id="active" name="status" type="radio" checked class="h-4 w-4 border-gray-300 text-cyan-600 focus:ring-cyan-600">
                                        <label for="active" class="ml-3 block text-sm font-medium leading-6 text-gray-900">Active</label>
                                    </div>
                                    <div class="flex items-center">
                                        <input value="0" id="inactive" name="status" type="radio" class="h-4 w-4 border-gray-300 text-cyan-600 focus:ring-cyan-600">
